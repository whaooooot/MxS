<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="repository.MovieAdminSessionRepository"%>
<%@ page import="model.*"%>
											...
											$
													.ajax({
														...
														success : function(data) {
															...
															document
																	.getElementById("moviePoster").value = fileName;
...
<body>
	...
	<form id="form1" name="form1" method="post">
		...
		<div>
			영화제목 <input name="movieTitle" id="movieTitle" 
				value="${movie.movieTitle}" placeholder="영화제목을 입력해주세요">
		</div>
		<div>
			상영시간 <input name="movieTime" id="movieTime" 
				value="${movie.movieTime}" placeholder="상영시간을 입력해주세요">
		</div>

		<div>
			영화장르 <input name="movieGenr" id="movieGenr" 
				value="${movie.movieGenr}" placeholder="장르를 입력해주세요">
		</div>
		<div>
			감독이름 <input name="movieDire" id="movieDire"
				value="${movie.movieDire}" placeholder="감독이름을 입력해주세요">
		</div>
		<div>
			배우이름 <input name="movieActor" id="movieActor"
				value="${movie.movieActor}" placeholder="배우이름을 입력해주세요">
		</div>
		<div>
			관람등급 <input name="movieGrade" id="movieGrade"
				value="${movie.movieGrade}" placeholder="관람등급을 입력해주세요">
		</div>
		<div>
			줄거리
		...
		<div>
			포스터 파일명 <input name="moviePoster" id="moviePoster"
