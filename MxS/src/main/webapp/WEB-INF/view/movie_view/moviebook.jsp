				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							...
							<td><p>
									<input type="button" class="btn btn-app-store" value="예매율순" />
								</p></td>
							<td><p>
									<input type="button" class="btn btn-app-store" value="가나다순" />
								</p></td>

							<td colspan="2">자주가는 극장<br /> <a href="#">설정</a> <br /> 자주가는
								극장를 등록해주세요.
							</td>
							...
							<td rowspan="3">3관<br /> <input type="button" value="1시" />10석<br />
								1관<br /> <input type="button" value="2시" />100석<input
								type="button" value="1시" />234석<br />
							</td>
