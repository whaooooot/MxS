			...
			<div class="popwrap">
				...
				<div class="pop-contents write-mygrade">
					<div class="mygrade-cont">
						<div class="movietit"><strong id="regTitle">해피 데스데이</strong></div>
						<div class="likeornot">
						...
						<div class="textbox">
                            ...
                            -->
                            <textarea id="textReviewContent" name="scoreCon" title="영화평점 입력" cols="70" rows="2" maxlength="140" placeholder="운영원칙에 어긋나는 게시물로 판단되는 글은 제재 조치를 받을 수 있습니다."></textarea>
						</div>
				...
				<button type="button" class="btn-close" id="regLayerClose" onclick="javascripti:history.back();">취소</button>
				<button type="submit" class="round red on" id="regBtn"><span>작성완료!</span></button>	
			</div></form:form>
		</div>
	</div>
</div>
