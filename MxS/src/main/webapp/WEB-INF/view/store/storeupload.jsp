...
<head>
    ...
    <title>#Tabs #upload #multiple - Bootsnipp.com</title>
    ...
    <link href="../css/storeupload.css?ver=1" rel="stylesheet" type="text/css">
        ...
        <div class="panel-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="Tabs-Kedua">
              ...
              <div class="row" id="image_preview"></div><br><br>
            </div>
    ...
    <form class="well col-sm-12 col-md-12">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <label>상품 이름</label>
                <input class="form-control" placeholder="상품이름" type="text">
                 <label>상품 간단 정보(15자이하)</label>
                <input class="form-control" placeholder="상품간단정보(15자이하)" type="text">
                <label>상품금액(숫자만)</label>
                <input class="form-control" placeholder="상품금액" type="text">
                <label>상품옵션1(색상)(,로 구분)</label>
                <input class="form-control" placeholder="상품옵션" type="text"> 
                  <label>상품옵션2(크기)(,로 구분)</label>
                <input class="form-control" placeholder="상품옵션" type="text"> 
                <label>상품 수</label>                
                <input class="form-control" placeholder="상품수" type="text"> 
